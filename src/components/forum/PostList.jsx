  ...
  if (loading) {
    return (
      <div className="flex flex-col items-center justify-center py-20 gap-4">
        ...
        <p className="text-gray-500 font-bold text-sm uppercase tracking-widest">Témák betöltése...</p>
      </div>
    );
  }
  ...
  if (posts.length === 0) {
    return (
      ...
      >
        ...
        <h3 className="text-xl font-black text-white uppercase tracking-tighter mb-2">Nincsenek találatok</h3>
        <p className="text-gray-500 max-w-xs mx-auto font-medium">Úgy tűnik ebben a kategóriában még nincsenek aktív beszélgetések.</p>
    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between mb-6 px-2">
        <h3 className="text-xs font-black uppercase tracking-[0.2em] text-gray-600 flex items-center gap-2">
           <Layers className="w-3.5 h-3.5" /> Legutóbbi Témák
        </h3>
        <div className="flex gap-4">
           <button className="text-[10px] font-black uppercase text-primary border-b-2 border-primary pb-1">Legfrissebb</button>
           <button className="text-[10px] font-black uppercase text-gray-700 hover:text-white transition-colors pb-1">Népszerű</button>
        </div>
      </div>
