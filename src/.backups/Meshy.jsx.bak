...
export default function Trellis2Panel({ selectedModel, getIdToken }) {
  ...
  return (
    <>
      ...
      <div className="flex h-full overflow-hidden bg-black font-sans relative">
              ...
              <div className="flex items-center gap-3 px-3">
                ...
                <Tooltip text={autoSpin ? "Deactivate Rotation" : "Activate Cinematic Cycle"} side="top">
                  <button
                    ...
                    className={`flex items-center gap-2.5 px-4 py-1.5 rounded-xl text-[9px] font-black uppercase tracking-widest transition-all cursor-pointer border-none ${autoSpin ? 'text-zinc-200' : 'text-zinc-600 hover:text-zinc-300'
                      }`}
                    style={autoSpin ? {
                      background: color,
