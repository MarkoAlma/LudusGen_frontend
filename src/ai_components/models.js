        ...
        categories: [
            {
                ...
                models: [
                    ...
                    { id: "mistral-large",   name: "Mistral Large (Mistral)",    apiModel: "mistral-large-latest",    provider: "mistral", color: "#f97316", defaultTemperature: 0.2, defaultMaxTokens: 2048, defaultTopP: 0.9  },
                    { id: "nvidia-glm4.7",   name: "Z.ai GLM 4.7 (NVIDIA)",    apiModel: "z-ai/glm4.7",    provider: "nvidia", color: "#16f921", defaultTemperature: 0.7, defaultMaxTokens: 2048, defaultTopP: 0.9 },
                    { id: "nvidia-kimi",   name: "(img) Kimi 2.5 (NVIDIA)",    apiModel: "moonshotai/kimi-k2.5",    provider: "nvidia", color: "#16f921", supportsVision: true, defaultTemperature: 0.7, defaultMaxTokens: 2048, defaultTopP: 1.0 },
                    { id: "qwen3.5-397b", name: "(img) Qwen 3.5 397B (NVIDIA)", apiModel: "qwen/qwen3.5-397b-a17b", provider: "nvidia", color: "#46f536", supportsVision: true, defaultTemperature: 0.6, defaultMaxTokens: 2048, defaultTopP: 0.95 },
                    { id: "qwen3-coder-480b", name: "Qwen 3 Coder 480B (NVIDIA)", apiModel: "qwen/qwen3-coder-480b-a35b-instruct", provider: "nvidia", color: "#16f921", defaultTemperature: 0.2, defaultMaxTokens: 2048, defaultTopP: 0.9 },
