...
import { User, Mail, Calendar, Shield, Edit2, Save, X, Check, AlertCircle, Lock, Sparkles, ChevronLeft, Camera, Upload, Trash2, XCircle } from "lucide-react";
            ...
            <div className="lg:col-span-4 space-y-6">
              <div className="glass-panel p-6 rounded-[2.5rem] border border-white/10">
                ...
                <div className="space-y-4">
                  ...
                  <InfoRow label="Account Type" value={user.accountType || "Standard"} icon={Sparkles} color="text-primary" />
