...
import bgConfig from '../../assets/bg-config.png';
      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            style={{ top: navHeight }}
          >
            <div className="flex-1 flex flex-col bg-[#000000]/65 backdrop-blur-[40px] border-l border-white/5 overflow-hidden relative">
              {/* ── Ambient Background ── */}
              <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden">
                ...
                <motion.div
                  ...
                  style={{ mixBlendMode: 'color', opacity: 0.04 }}
                />

                {/* Accent Gradients - Lower Lighting */}
                <div
                  className="absolute -top-32 -left-32 w-96 h-96 opacity-[0.01] blur-[120px] transition-all duration-1000"
                  style={{ background: `radial-gradient(circle, ${themeColor}, transparent)` }}
                />
                <div className="absolute top-1/2 -right-40 w-64 h-64 bg-purple-900/01 blur-[100px] rounded-full" />
                <div className="absolute bottom-0 left-0 right-0 h-48 bg-gradient-to-t from-[#000000] to-transparent opacity-95" />
              </div>
