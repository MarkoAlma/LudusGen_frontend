        ...
        models: [
          {
            ...
            panelType: "chat",
            defaultSystemPrompt:
              "You are a helpful, harmless, and honest assistant. Respond in the same language the user writes in.",
          },
          {
            id: "claude_opus",
            name: "Claude Opus 4",
        ...
        models: [
          {
            ...
            tierLabel: "Ingyenes",
            description:
              "Gyors, ingyenes DeepSeek modell OpenRouter-en keresztül",
          ...
          },
          {
            ...
            tierLabel: "Ingyenes",
            description:
              "DeepSeek chat modell ingyenes OpenRouter hozzáféréssel",
            badge: "Free / napi limit",
          ...
          },
          {
            ...
            tierLabel: "Ingyenes",
            description:
              "Gyors és hatékony nyílt forráskódú modell OpenRouter-en",
            badge: "Free / korlátlan",
          ...
          },
          {
            ...
            tier: "lite",
            tierLabel: "Ingyenes",
            description: "Nagy kontextusú (128K) ingyenes OpenRouter modell",
            badge: "Free / 128K kontextus",
            apiModel: "qwen/qwen-72b-chat:free",
            provider: "openrouter",
            color: "#a855f7",
        ...
        models: [
          {
            ...
            tierLabel: "Ingyenes",
            description:
              "Profi fejlesztőasszisztens DeepSeek ingyenes OpenRouter hozzáféréssel",
            badge: "Free / napi limit",
            apiModel: "deepseek/deepseek-r1-0528:free",
            provider: "openrouter",
            color: "#6366f1",
...
export const DEFAULT_PRESETS = {
  chat: [
    ...
    },
    {
      ...
      systemPrompt:
        "You are a creative and imaginative assistant. Think outside the box, use vivid language, and offer unexpected perspectives. Respond in the same language the user writes in.",
      temperature: 1.1,
      maxTokens: 3000,
      topP: 0.95,
      isDefault: true,
    },
    {
      ...
      systemPrompt:
        "You are a precise and factual assistant. Provide accurate, well-structured information. Cite your reasoning. Avoid speculation. Respond in the same language the user writes in.",
      temperature: 0.3,
      maxTokens: 2048,
      topP: 0.85,
      isDefault: true,
...
Respond in the same language the user writes in.`,
    ...
    },
    {
      ...
      systemPrompt:
        "You are a patient and thorough teacher. Break down complex topics into simple, digestible parts. Use examples and analogies. Adapt to the student's level. Respond in the same language the user writes in.",
      temperature: 0.6,
      maxTokens: 3000,
      topP: 0.9,
      isDefault: true,
    },
    {
      ...
      systemPrompt:
        "You are a professional translator. Provide accurate, natural-sounding translations. Preserve tone, nuance, and cultural context. If multiple translations are possible, explain the differences.",
      temperature: 0.3,
      maxTokens: 2048,
      topP: 0.9,
      isDefault: true,
  ...
  image: [
    {
      ...
      positivePrefix:
        "photorealistic, 8k uhd, professional photography, sharp focus, detailed, ",
      negativePrompt:
        "cartoon, anime, painting, drawing, illustration, blurry, low quality, watermark",
      width: 1024,
      height: 1024,
      steps: 30,
      guidance: 7.5,
    ...
    },
    {
      ...
      positivePrefix:
        "anime style, high quality anime, detailed anime artwork, vibrant colors, ",
    ...
    },
    {
      ...
      positivePrefix:
        "oil painting, impressionist style, thick brushstrokes, canvas texture, artistic, ",
    ...
    },
    {
      ...
      positivePrefix:
        "cinematic shot, dramatic lighting, film grain, movie scene, professional cinematography, ",
