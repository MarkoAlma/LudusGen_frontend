    ...
    >
      ...
      >
        <div className="absolute inset-0 z-0">
          ...
          <div
            className="absolute top-1/3 right-1/4 w-2 h-2 bg-cyan-400 rounded-full animate-ping"
            style={{ animationDelay: "1s" }}
          />
          <div
            className="absolute bottom-1/3 left-1/4 w-2 h-2 bg-pink-400 rounded-full animate-ping"
        ...
        <div className="max-w-6xl mx-auto px-4 text-center relative z-10">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center mb-16 ">
            {/* Primary CTA */}
            <button className="group cursor-pointer relative overflow-hidden px-12 py-6 rounded-full text-xl font-black shadow-2xl transform hover:scale-105 transition-all duration-300">
              {/* Base gradient */}
              ...
              <span className="relative z-10 flex items-center justify-center uppercase tracking-wider">
                ...
                <Rocket className="ml-2 w-6 h-6 group-hover:translate-y-[-4px] transition-transform" />
              </span>
            ...
            {/* Secondary CTA */}
            <button className="group cursor-pointer relative overflow-hidden px-12 py-6 rounded-full text-xl font-black backdrop-blur-2xl border-2 border-white/30 hover:border-white/60 transition-all transform hover:scale-105 duration-300">
              {/* Glow on hover */}
              ...
              <span className="relative flex items-center justify-center">
                ...
                <ArrowRight className="ml-3 w-6 h-6 group-hover:translate-x-2 transition-transform text-white group-hover:text-cyan-400" />
              </span>
            </button>
          </div>
          {/* Feature Pills */}
          <div className="flex flex-wrap justify-center gap-4">
            {features.map((feature, idx) => {
              ...
              return (
                <div
                  key={idx}
                  className="flex items-center space-x-3 px-6 py-3 bg-white/5 backdrop-blur-xl border border-white/10 rounded-full hover:bg-white/10 transition-all"
                >
