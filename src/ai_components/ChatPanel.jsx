  ...
  return (
    <div className="flex flex-1 w-full h-full bg-[#03000a] text-white overflow-hidden relative">
      ...
      >
        ...
        {/* Input area */}
        <div className="w-full px-8 lg:px-12 pb-6 pt-1">
          <ChatInput
              input={input}
              setInput={setInput}
              isTyping={isTyping}
