...
import { Sparkles, Menu, X, ArrowRight, Zap, Home, Bolt, Gem, Phone, User as UserIcon, LogOut, Settings, ChevronDown } from "lucide-react";
...
export default function Navbar({ scrollY }) {
  ...
  const {isAuthOpen, setIsAuthOpen, showNavbar, setShowNavbar, user, logoutUser} = useContext(MyUserContext)
                    ...
                    <div className="absolute right-0 mt-3 w-64 rounded-2xl overflow-hidden backdrop-blur-xl bg-gradient-to-br from-black/90 via-purple-950/90 to-black/90 border border-purple-500/30 shadow-[0_0_50px_rgba(168,85,247,0.5)] animate-slideDown">
                      ...
                      <div className="relative p-2">
                        ...
                        >
                          ...
                          <span className="text-white font-semibold">Beállítások</span>
                        </button>
                        ...
                        >
                          ...
                          <span className="text-white font-semibold">Kijelentkezés</span>
                        </button>
                      </div>
                    </div>
                  )}
