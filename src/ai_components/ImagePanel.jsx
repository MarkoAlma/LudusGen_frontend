...
export default function ImagePanel({ selectedModel, userId, getIdToken }) {
  ...
  // ── FLUX Kontext ───────────────────────────────────
  const [kontextAspectRatio, setKontextAspectRatio] =
    ...
    >
      {KONTEXT_ASPECT_RATIOS.map((ar) => {
        ...
        return (
          <button
            key={ar.value}
            onClick={() => setKontextAspectRatio(ar.value)}
            style={{
              padding: "8px 4px",
              borderRadius: 12,
              cursor: "pointer",
        ...
        >
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
              ...
              <span
                style={{
                  ...
                  alignItems: "center",
                  gap: 5,
                  background: `${providerMeta.color}12`,
            ...
            {isFluxKontext && (
              <div>
                ...
                >
                  Input kép
                  <span
                    style={{ color: "#ef4444", fontSize: 13, lineHeight: 1 }}
                  >
                    *
                  </span>
                </label>
                ...
                {inputImage ? (
                  ...
                  >
                    <Upload
                      style={{ width: 20, height: 20, color: `${color}55` }}
                    />
                    <span
                      style={{
                        color: "#6b7280",
            ...
            <div>
              ...
              <div style={{ position: "relative" }}>
                <textarea
                  ...
                  placeholder={
                    isFluxKontext
                      ? "Pl. Replace the background with a forest..."
                      : "Írd le a képet részletesen..."
                  }
                  rows={4}
                  style={{
                    width: "100%",
              ...
              >
                ...
                {(isFal || isNvidia) && (
                  <div>
                    ...
                    >
                      <label style={{ color: "#6b7280", fontSize: 12 }}>
                        Steps
                      </label>
                      <span style={{ fontSize: 11, fontWeight: 700, color }}>
                        {steps}
                ...
                {(isFal || isNvidia) && (
                  <div>
                    ...
                    <input
                      type="range"
                      min={1}
                      max={isFlux || isFluxKontext ? 30 : 20}
                      step={0.5}
                      value={guidance}
                    ...
                    />
                    <p style={{ color: "#4b5563", fontSize: 11, marginTop: 2 }}>
                      Alacsony = kreatív · Magas = prompt-hű
                    </p>
                  </div>
                )}
              </div>
          ...
          <div style={{ padding: "12px 16px 16px", flexShrink: 0 }}>
            <button
              ...
              disabled={
                !prompt.trim() || isGenerating || (isFluxKontext && !inputImage)
              }
              style={{
                width: "100%",
                padding: "12px 0",
          ...
          <div style={{ flex: 1, position: "relative", minHeight: 0 }}>
            ...
            {!isGenerating && generatedImages.length === 0 && !error && (
              ...
              >
                ...
                >
                  <ImageIcon
                    style={{ width: 32, height: 32, color: `${color}40` }}
                  />
                </div>
                <div style={{ textAlign: "center" }}>
                  ...
                  >
                    {isFluxKontext
                      ? "Tölts fel egy képet és adj utasítást"
                      : "Még nincs kép"}
                  </p>
                  <p style={{ color: "#374151", fontSize: 12 }}>
                    {isFluxKontext
                      ? "A Kontext modell meglévő képek szerkesztésére specializálódott"
                      : "Írj egy promptot a bal oldalon"}
                  </p>
                </div>
                {!isFluxKontext && (
                  <div
                ...
                {generatedImages.map((img, i) => (
                  <div
                    ...
                    style={{
                      ...
                      aspectRatio: `${selectedAR.w} / ${selectedAR.h}`,
                      maxWidth:
                        generatedImages.length > 1 ? "calc(50% - 6px)" : "100%",
                      maxHeight: "100%",
                      width: "auto",
                      height: "100%",
                      flexShrink: 0,
